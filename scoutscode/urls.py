...
urlpatterns = [
    ...
    path("accounts/bookmarks/", bookmarks_page, name="bookmarks"),
    ...
    path("api/bookmarks/save/", save_bookmark, name="save_bookmark"),
    path("api/bookmarks/remove/", remove_bookmark, name="remove_bookmark"),

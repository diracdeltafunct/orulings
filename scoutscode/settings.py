"""
Django settings for scoutscode project.
...
MIDDLEWARE = [
    ...
    "post.middleware.AuthenticatedHeaderMiddleware",
]
...
WSGI_APPLICATION = "scoutscode.wsgi.application"
...
# Rate limiting - use X-Forwarded-For behind reverse proxy, REMOTE_ADDR locally
if not DEBUG:
